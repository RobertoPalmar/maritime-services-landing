...
export const translations = {
  es: {
    ...
    hero: {
      tagline: "Más de una década operando en Venezuela",
      title1: "Resolvemos",
      title2: "Venezuela",
      description: "Suministro naval garantizado para flotas internacionales en los puertos más complejos de Venezuela. Cuando otros proveedores fallan, nosotros entregamos.",
      cta: "Solicitar Cotización",
      ctaSecondary: "Nuestros Servicios",
      imageAlt: "Buque comercial atracado en puerto venezolano",
    },
    carousel: {
    ...
    contact: {
      ...
      form: {
        ...
        vesselNamePlaceholder: "Ej. MV Atlantic Star",
        imo: "Número IMO",
        imoPlaceholder: "Ej. 9074729",
        portOfCall: "Puerto de escala",
        portOfCallPlaceholder: "Seleccione un puerto",
        portOptions: [
          { value: "maracaibo", label: "Puerto de Maracaibo" },
  ...
  en: {
    ...
    hero: {
      tagline: "Over a decade operating in Venezuela",
      title1: "We Solve",
      title2: "Venezuela",
      description: "Guaranteed ship supply for international fleets in Venezuela's most complex ports. When other suppliers fail, we deliver.",
      cta: "Request Port Call Quote",
      ctaSecondary: "Our Services",
      imageAlt: "Commercial vessel berthed at a Venezuelan port",
    },
    carousel: {
    ...
    contact: {
      ...
      form: {
        ...
        vesselNamePlaceholder: "E.g. MV Atlantic Star",
        imo: "IMO number",
        imoPlaceholder: "E.g. 9074729",
        portOfCall: "Port of call",
        portOfCallPlaceholder: "Select a port",
        portOptions: [
          { value: "maracaibo", label: "Port of Maracaibo" },
          { value: "la-salina", label: "La Salina" },
          { value: "bajo-grande", label: "Bajo Grande" },
          { value: "puerto-cabello", label: "Puerto Cabello" },
