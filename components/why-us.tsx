...
import { MapPin, Settings, ShieldCheck, Clock } from "lucide-react"
import { Card, CardContent } from "@/components/ui/card"
import { useI18n } from "@/lib/i18n-context"
import { TranslatedBlock } from "@/components/translated-text"
import { FadeInSection } from "@/components/fade-in-section"

const featureIcons = [MapPin, Settings, ShieldCheck, Clock]
...
export function WhyUs() {
  ...
  return (
    <section id={sectionId} className="py-24 lg:py-32 bg-primary text-primary-foreground">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <TranslatedBlock className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
