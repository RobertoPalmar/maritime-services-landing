...
export function About() {
  ...
  return (
    <section id={sectionId} className="bg-primary text-primary-foreground overflow-hidden">
      ...
      <div className="pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <FadeInSection direction="up" delay={200}>
            <TranslatedBlock>
              <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mx-auto">
